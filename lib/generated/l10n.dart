...
class S {
  ...
  String get choose_vehicle_type1 {
    return Intl.message(
      'Choose Vehicle Type',
      name: 'choose_vehicle_type1',
      desc: '',
      args: [],
    );
  }
  ...
  String get should_be_more_than_10_letters {
    return Intl.message(
      ...
      name: 'enter_Valid_10_digit_number',
      desc: '',
      args: [],
    );
  }
