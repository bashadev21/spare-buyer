                        ...
                        SliverToBoxAdapter(
                          child: Wrap(
                            children: [
                              Padding(
                                padding:
                                    const EdgeInsets.only(right: 20, left: 20, bottom: 10, top: 25),
                                child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: _con.restaurant.closed ? Colors.grey : Colors.green,
                                  ...
                                  Container(
                                    padding: EdgeInsets.symmetric(horizontal: 12, vertical: 3),
                                    decoration: BoxDecoration(
                                        color: Helper.canDelivery(_con.restaurant)
                                            ? Colors.green
                                            : Colors.grey,
                                        borderRadius: BorderRadius.circular(24)),
                                    child: Text(
                    ...
                    Positioned(
                      ...
                      child: ShoppingCartFloatButtonWidget(
                          ...
                          routeArgument: RouteArgument(
                              id: '0', param: _con.restaurant.id, heroTag: 'home_slide')),
                    ),
                  ],
                ),
        ));
